...
if __name__=="__main__":
    ...
    # print(model.green_open_time)
    # result = model.Hd1Analysis(model.green_open_time[2])#[0]
    
    # print(result["idQmfj"]) # [result.columns[:12]]
    ...
    df.to_excel("data/summary/hd4_03_05_25.xlsx",index=False)
    ...
    for f in all_files:
        ...
        df.append(df_)
    df = pd.concat(df,ignore_index=True)
    df.to_excel("data/summary/hd_check_03_05_25.xlsx",index=False)
    ...
    for f in all_files:
        ...
        df.append(df_)
    df = pd.concat(df,ignore_index=True)
    df.to_excel("data/summary/hd1_03_05_25.xlsx",index=False)
