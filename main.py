...
if __name__=="__main__":
    ...
    if mode=="test":
        ...
        df.to_excel("test/Headway_Sat_C_x_13M_SemMotobox_D5_0001_Teste2.xlsx",index=False)

        df1 = pd.concat(df1,ignore_index=True)
        df1 = df1.drop_duplicates(subset="id",keep="last")
        df1.to_excel("test/Headway_Geral_C_x_13M_SemMotobox_D5_0001_Teste2.xlsx",index=False)
